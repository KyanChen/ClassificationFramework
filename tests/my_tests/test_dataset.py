...
from mmcls.datasets import DATASETS, ClsFolderDataset, build_dataset
...
def test_dataset():
    config_path = '/Users/kyanchen/Code/ClassificationFramework/configs/my_configs/resnet34_b32x8_UC.py'
